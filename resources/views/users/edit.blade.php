...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0">
                <i class="fas fa-user-edit me-2" style="color: #2d8659;"></i>
                Edit User
            </h2>
        ...
        <div class="card">
            <div class="card-body">
                <div id="loading-user" class="text-center py-5">
...
<script>
    ...
    async function loadUser() {
        const response = await apiCall(`/users/${userId}`, 'GET', null, false);
        ...
        if (response && response.data.success) {
            ...
            showFlash('Failed to load user data', 'danger');
            setTimeout(() => {
    ...
    function fillForm() {
        ...
        // Display roles with checked ones
    ...
    document.getElementById('edit-user-form').addEventListener('submit', async function(e) {
        ...
        const response = await apiCall(`/users/${userId}`, 'PUT', data);
        ...
        if (response && response.data.success) {
            ...
            if (response?.data?.errors) {
                ...
                showFlash(response?.data?.message || 'Failed to update user', 'danger');
            }
        }
    });
</script>
